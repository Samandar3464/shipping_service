...
public interface AnnouncementClientRepository extends JpaRepository<AnnouncementClient, UUID> {
    ...
    List<AnnouncementClient> findAllByUserIdAndDeletedFalseOrderByCreatedTime(UUID id);
    List<AnnouncementClient> findAllByUserIdAndActiveAndDeletedFalseOrderByCreatedTimeDesc(UUID id, boolean active);
}
